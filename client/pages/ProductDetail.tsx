            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-ag-green-50 rounded-xl p-4 border border-ag-green-100">
                  ...
                  <div className="text-3xl font-bold text-ag-green-600">{product.sold.toLocaleString()}</div>
                </div>
                <div className="bg-ag-green-50 rounded-xl p-4 border border-ag-green-100">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setQuantity(
                              Math.min(product.available, Math.max(1, parseInt(e.target.value) || 1))
                            )
                          }
            ...
            <div className="mt-16 border-t border-border pt-12">
              ...
              <div className="space-y-4">
                {product.reviews.map((review) => (
                  <div key={review.id} className="bg-ag-green-50 rounded-xl p-6 border border-ag-green-100">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <div className="font-semibold text-foreground">{review.buyerName}</div>
