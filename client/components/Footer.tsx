        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/forecast" className="text-muted-foreground hover:text-primary transition-colors">
                  {t('nav.forecast')}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@agrohub.com" className="text-muted-foreground hover:text-primary transition-colors">
                  info@agrohub.com
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              © {currentYear} AgroHub. {t('footer.all_rights_reserved')}
            </p>
